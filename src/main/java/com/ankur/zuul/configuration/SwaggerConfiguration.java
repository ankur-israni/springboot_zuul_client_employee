package com.ankur.zuul.configuration;
...
public class SwaggerConfiguration {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("This service provides CRUD operations for Employee Management.")
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("Employee Management Microservice")
                .select()
